...
These tend to be highly energy consuming mechanisms which control the building in a global not-so-smart manner -- turning the central heating on in the entire building even though certain rooms are empty is definitely not a smart behaviour, for example.
