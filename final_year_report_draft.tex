...
%
%%%%%%%%%%%%%%%%%%   FG: These are not aims and objectives. They are more "steps". Maybe find a better section title?
...
\ \\
%
This project was suggested by the Computer Technology Institute and Press "Diophantus".  %%%%%%%%%%%%%%%%%%   FG: Where is the institute from? EXPLAIN.
%
\begin{quote}
