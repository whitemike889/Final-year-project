...
\newenvironment{elements}
    {\begin{quote}\itshape}
    {\end{quote}}
% FG: Rename bibliography to References
...
In this way, it is possible to detect if any or more of the relays have failed.
With this technique, precious time is saved from removing the \textit{action} board. \\ %%%%%%%%%%%%%%%%%%   FG: What does this mean? Removing the board?
\ \\
\begin{figure}[H]
\centering
...
This way the system does not have to be removed in case any of the boards has a defect and is down.\\ %%%%%%%%%%%%%%%%%%   FG: What does this mean? Removed?
\ \\
...
Therefore different current values will be measured in the \textit{relayCheckPin}. %%%%%%%%%%%%%%%%%%   FG: What is relayChickenPin? SPECIFY.
...
The received data from the Controller is checked to see if it contains any measured value from the relay(s) and in what state does it set it. %%%%%%%%%%%%%%%%%%   FG: "what state does is set it" is chinese? What is this about? 
...
Explain the temp function. \\ %%%%%%%%%%%%%%%%%%   FG: What is this??
\ \\
...
With the use of Java a database is created by pointing the existence of a database in a computer-server as well as a WiseDB database. %%%%%%%%%%%%%%%%%%   FG: This is chinese. Explain it to me.
...
This is due to the fact of electronics dissipating heat. %%%%%%%%%%%%%%%%%%   FG: What does this mean? Are people burning alive?
\begin{figure}[H]
\centering
...
This is due to just a small drop of temperature. %%%%%%%%%%%%%%%%%%   FG: Ventilation for drop of temperature? They wanted to freeze?
\begin{figure}[H]
\centering
...
%%%%%%%%%%%%%%%%%%   FG: Can't find the link between pressure sensor and separate user preferences.
\ \\
