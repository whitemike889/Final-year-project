...
With this technique, precious time is saved as the\textit{action} board does not have to be removed. \\ %%% DK
\ \\
\begin{figure}[H]
\centering
...
This way it does not have to be removed in case any of the boards has a defect and is down.\\ %%%%%%%%%%%%%%%%%%   FG: What does this mean? Removed? %%% DK: if one of the boards has a defect it does not have to take down the whole system to repair.
\ \\
...
The \textit{relayCheckPin} is a dedicated analogue pin (A4) on the Arduino Mini Pro board. %%% DK: relayCheckPin
